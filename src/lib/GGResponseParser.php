...
class GGResponseParser
{
     ...
     * @throws Exception
     */
    public static function parseHotelsList(string $xmlString): array
    {
     ...
     * @throws Exception
     */
    public static function parseHotelInfo(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parseBookingInsert(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        if (isset($xml->Main->Error)) {
            $response['error'] = (string)$xml->Main->Error;
     ...
     * @throws Exception
     */
    public static function parseBookingCancel(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parseBookingSearch(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parseBookingSearchAdv(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parseBookingCheckStatus(string  $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parseBookingValuationCheck(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parseBookingVoucher(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parsePiggyPoints(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parsePaymentService(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
     ...
     * @throws Exception
     */
    public static function parsePriceBreakdown(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
            ...
            foreach ($xml->Main->Room as $room) {
                ...
                foreach ($room->PriceBreakdown as $priceBreakDown) {
                    $priceData = [
                        'FromDate' => (string)$priceBreakDown->FromDate,
                        'ToDate' => (string)$priceBreakDown->ToDate,
                        'Price' => (string)$priceBreakDown->Price,
                        'Currency' => (string)$priceBreakDown->Currency
                    ];
     ...
     * @throws Exception
     */
    public static function parseBookingAmendmentInfo(string $xmlString): array
    {
        $xml = new SimpleXMLElement($xmlString);
        $response = [];
        if (isset($xml->Main->Error)) {
